...
const EmbedChatbot = () => {
    ...
    return (
        <div>
            ...
            <div className={
                isOpen
                    ? "fixed flex flex-col items-start justify-center gap-8 right-0 bottom-0 w-full h-full bg-white/30 p-4 sm:p-8 ease-out duration-700 bg-opacity-50 backdrop-blur z-[9999]"
